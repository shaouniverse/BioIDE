...
public interface TaxonRepository extends BaseRepository<Taxon, String> {
     ...
     */
    @Query(value = "Select t from Taxon t where (t.scientificname like %?1% or t.authorstr like %?1% or t.epithet like %?1% or t.inputer like %?1% or t.inputtime like %?1%) and t.status = 1")
